...
/**
 * 复制shiro的DefaultWebSessionManager，修改代码可以从请求头中获取JSESSION
 * @author 锁战强
 *
 */
public class DefaultWebSessionManager extends DefaultSessionManager implements WebSessionManager {
    ...
    private Serializable getReferencedSessionId(ServletRequest request, ServletResponse response) {
        ...
        if (id != null) {
            ...
            //not in a cookie, or cookie is disabled - try the request header and URI as a fallback (i.e. due to URL rewriting):
        	//try request header 
        	//添加从请求头获取JESSIONID
        	id = getHeaderValue(request, ShiroHttpSession.DEFAULT_SESSION_ID_NAME);
    ...
    private String getHeaderValue(ServletRequest request,String key) {
    	HttpServletRequest re = (HttpServletRequest) request;
    	return re.getHeader(key);
    }
